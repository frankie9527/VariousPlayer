 ...
 * func:
 */
public class SimpleBottomView extends BaseBottomView {
    String TAG="VideoBottomView";

    public SimpleBottomView(@NonNull Context context) {
        super(context);
    }

    public SimpleBottomView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
